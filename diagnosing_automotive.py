...
with ruleset("diagnosing_automotive"):
    ...
    @when_all((m.engine_turns_over == False) & (m.light_come_on == False))
    def problem_is_battery_or_cables(c):
        print(c.m)
        print("The problem is battery of cables")

    # problem_is_starter_motor ?
    @when_all((m.engine_turns_over == False) & (m.light_come_on == True))
    def problem_is_starter_motor(c):
        print(c.m)
        print("The problem starter motor")
    ...
    def engine_is_getting_gas(c):
        post(
            ...
            "engine_turn_over":c.m.engine_turns_over,
    ...
    def engine_get_gas_unknown(c):
        post(
            ...
            "engine_turn_over":c.m.engine_turn_over,
            "Lights_come_on":c.m.lights_come_on,
            }
        )
...
for (
    ...
    print("diagnosing_automotive", fact)
